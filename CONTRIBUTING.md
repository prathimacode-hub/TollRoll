...
Welcome to [prathimacode-hub/TollRoll](https://github.com/prathimacode-hub/TollRoll/). Before sending your pull requests, make sure that you **read the whole
...
* Step 2: Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/prathimacode-hub/TollRoll.git
    ```
* Step 3: Keep your cloned repo upto date by pulling from upstream (this will also avoid any merge conflicts while committing new changes)
    ```
    git pull upstream main https://github.com/prathimacode-hub/TollRoll.git
    ```
...
4. Participants / Contributors can also **open their issues** using [issue_template](https://github.com/prathimacode-hub/TollRoll/tree/main/.github/issue_template),
...
1. Please fill the **[PR Template](https://github.com/prathimacode-hub/TollRoll/blob/main/.github/pullrequest_template.md)** properly while making a Pull Request.
...
7. - Do not update the [README.md](https://github.com/prathimacode-hub/TollRoll/blob/main/README.md) and [CONTRIBUTING.md](https://github.com/prathimacode-hub/TollRoll/blob/main/CONTRIBUTING.md).
